...
export namespace Prisma {
  ...
  */
  ...
  export type UserOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "email" | "passwordHash" | "role" | "isLocked" | "permissions" | "createdAt" | "updatedAt", ExtArgs["result"]["user"]>
  ...
  export type UserHistoryOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "userId" | "email" | "role" | "permissions" | "changedAt" | "changedBy", ExtArgs["result"]["userHistory"]>
  ...
  interface UserHistoryFieldRefs {
    ...
    readonly email: FieldRef<"UserHistory", 'String'>
    readonly role: FieldRef<"UserHistory", 'Role'>
    readonly permissions: FieldRef<"UserHistory", 'String[]'>
    readonly changedAt: FieldRef<"UserHistory", 'DateTime'>
    readonly changedBy: FieldRef<"UserHistory", 'String'>
  }
  ...
  export type UserHistoryWhereInput = {
    ...
    email?: StringFilter<"UserHistory"> | string
    role?: EnumRoleFilter<"UserHistory"> | $Enums.Role
    permissions?: StringNullableListFilter<"UserHistory">
    changedAt?: DateTimeFilter<"UserHistory"> | Date | string
    changedBy?: StringNullableFilter<"UserHistory"> | string | null
  }
  ...
  export type UserHistoryScalarWhereWithAggregatesInput = {
    ...
    email?: StringWithAggregatesFilter<"UserHistory"> | string
    role?: EnumRoleWithAggregatesFilter<"UserHistory"> | $Enums.Role
    permissions?: StringNullableListFilter<"UserHistory">
    changedAt?: DateTimeWithAggregatesFilter<"UserHistory"> | Date | string
    changedBy?: StringNullableWithAggregatesFilter<"UserHistory"> | string | null
  }
  ...
  export type UserHistoryCreateInput = {
    ...
    email: string
    role: $Enums.Role
    permissions?: UserHistoryCreatepermissionsInput | string[]
  ...
  export type UserHistoryUpdateInput = {
    ...
    email?: StringFieldUpdateOperationsInput | string
    role?: EnumRoleFieldUpdateOperationsInput | $Enums.Role
    permissions?: UserHistoryUpdatepermissionsInput | string[]
  ...
  export type UserHistoryCreatepermissionsInput = {
    set: string[]
  }

  export type UserHistoryUpdatepermissionsInput = {
    set?: string[]
    push?: string | string[]
  }
