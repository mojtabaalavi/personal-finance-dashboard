...
export namespace Prisma {
  ...
  */
  ...
  export type TypeMap<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs, GlobalOmitOptions = {}> = {
    ...
    meta: {
      modelProps: "conversation" | "message" | "insight" | "analyticsCache"
  ...
  export type ConversationCountAggregateOutputType = {
    ...
    title: number
    status: number
    contextAccountIds: number
    contextPropertyIds: number
    createdAt: number
    updatedAt: number
    _all: number
  }
  ...
  export type ConversationCountAggregateInputType = {
    ...
    title?: true
    status?: true
    contextAccountIds?: true
    contextPropertyIds?: true
    createdAt?: true
    updatedAt?: true
    _all?: true
  }
  ...
  export type ConversationSelect<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetSelect<{
    ...
    title?: boolean
    status?: boolean
    contextAccountIds?: boolean
    contextPropertyIds?: boolean
    createdAt?: boolean
    updatedAt?: boolean
  ...
  export type ConversationOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "userId" | "title" | "status" | "contextAccountIds" | "contextPropertyIds" | "createdAt" | "updatedAt", ExtArgs["result"]["conversation"]>
  ...
  interface ConversationFieldRefs {
    ...
    readonly contextAccountIds: FieldRef<"Conversation", 'String[]'>
    readonly contextPropertyIds: FieldRef<"Conversation", 'String[]'>
  ...
  export type MessageOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "conversationId" | "role" | "content" | "model" | "tokenCount" | "processingTime" | "createdAt", ExtArgs["result"]["message"]>
  ...
  interface MessageFieldRefs {
    ...
    readonly processingTime: FieldRef<"Message", 'Int'>
  ...
  export type InsightSelect<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetSelect<{
    ...
    isRead?: boolean
    isDismissed?: boolean
    relatedTransactionIds?: boolean
    relatedConversationId?: boolean
    createdAt?: boolean
    expiresAt?: boolean
  ...
  export type InsightOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "userId" | "title" | "description" | "category" | "priority" | "isRead" | "isDismissed" | "relatedTransactionIds" | "relatedConversationId" | "createdAt" | "expiresAt", ExtArgs["result"]["insight"]>
  ...
  interface InsightFieldRefs {
    ...
    readonly isDismissed: FieldRef<"Insight", 'Boolean'>
    readonly relatedTransactionIds: FieldRef<"Insight", 'String[]'>
    readonly relatedConversationId: FieldRef<"Insight", 'String'>
    readonly createdAt: FieldRef<"Insight", 'DateTime'>
    readonly expiresAt: FieldRef<"Insight", 'DateTime'>
  }
  ...
  export type AnalyticsCacheOmit<ExtArgs extends $Extensions.InternalArgs = $Extensions.DefaultArgs> = $Extensions.GetOmit<"id" | "userId" | "cacheKey" | "data" | "expiresAt" | "createdAt", ExtArgs["result"]["analyticsCache"]>
  ...
  interface AnalyticsCacheFieldRefs {
    ...
    readonly userId: FieldRef<"AnalyticsCache", 'String'>
    readonly cacheKey: FieldRef<"AnalyticsCache", 'String'>
    readonly data: FieldRef<"AnalyticsCache", 'Json'>
    readonly expiresAt: FieldRef<"AnalyticsCache", 'DateTime'>
    readonly createdAt: FieldRef<"AnalyticsCache", 'DateTime'>
  }
  ...
  export type ConversationWhereInput = {
    ...
    contextAccountIds?: StringNullableListFilter<"Conversation">
    contextPropertyIds?: StringNullableListFilter<"Conversation">
  ...
  export type ConversationOrderByWithRelationInput = {
    ...
    title?: SortOrder
    status?: SortOrder
    contextAccountIds?: SortOrder
    contextPropertyIds?: SortOrder
    createdAt?: SortOrder
    updatedAt?: SortOrder
  ...
  export type MessageWhereInput = {
    ...
    processingTime?: IntNullableFilter<"Message"> | number | null
  ...
  export type MessageScalarWhereWithAggregatesInput = {
    ...
    processingTime?: IntNullableWithAggregatesFilter<"Message"> | number | null
  ...
  export type InsightWhereInput = {
    ...
    isDismissed?: BoolFilter<"Insight"> | boolean
    relatedTransactionIds?: StringNullableListFilter<"Insight">
    relatedConversationId?: StringNullableFilter<"Insight"> | string | null
    createdAt?: DateTimeFilter<"Insight"> | Date | string
    expiresAt?: DateTimeNullableFilter<"Insight"> | Date | string | null
  }
  ...
  export type InsightOrderByWithRelationInput = {
    ...
    relatedTransactionIds?: SortOrder
    relatedConversationId?: SortOrderInput | SortOrder
    createdAt?: SortOrder
  ...
  export type InsightScalarWhereWithAggregatesInput = {
    ...
    isDismissed?: BoolWithAggregatesFilter<"Insight"> | boolean
    relatedTransactionIds?: StringNullableListFilter<"Insight">
    relatedConversationId?: StringNullableWithAggregatesFilter<"Insight"> | string | null
    createdAt?: DateTimeWithAggregatesFilter<"Insight"> | Date | string
    expiresAt?: DateTimeNullableWithAggregatesFilter<"Insight"> | Date | string | null
  }
  ...
  export type AnalyticsCacheWhereInput = {
    ...
    id?: StringFilter<"AnalyticsCache"> | string
    userId?: StringFilter<"AnalyticsCache"> | string
    cacheKey?: StringFilter<"AnalyticsCache"> | string
    data?: JsonFilter<"AnalyticsCache">
    expiresAt?: DateTimeFilter<"AnalyticsCache"> | Date | string
    createdAt?: DateTimeFilter<"AnalyticsCache"> | Date | string
  }
  ...
  export type AnalyticsCacheWhereUniqueInput = Prisma.AtLeast<{
    id?: string
    userId_cacheKey?: AnalyticsCacheUserIdCacheKeyCompoundUniqueInput
    AND?: AnalyticsCacheWhereInput | AnalyticsCacheWhereInput[]
    OR?: AnalyticsCacheWhereInput[]
    NOT?: AnalyticsCacheWhereInput | AnalyticsCacheWhereInput[]
    userId?: StringFilter<"AnalyticsCache"> | string
  ...
  export type AnalyticsCacheScalarWhereWithAggregatesInput = {
    ...
    id?: StringWithAggregatesFilter<"AnalyticsCache"> | string
    userId?: StringWithAggregatesFilter<"AnalyticsCache"> | string
    cacheKey?: StringWithAggregatesFilter<"AnalyticsCache"> | string
    data?: JsonWithAggregatesFilter<"AnalyticsCache">
    expiresAt?: DateTimeWithAggregatesFilter<"AnalyticsCache"> | Date | string
    createdAt?: DateTimeWithAggregatesFilter<"AnalyticsCache"> | Date | string
  }
  ...
  export type ConversationCreateInput = {
    ...
    title?: string
    status?: $Enums.ConversationStatus
    contextAccountIds?: ConversationCreatecontextAccountIdsInput | string[]
    contextPropertyIds?: ConversationCreatecontextPropertyIdsInput | string[]
  ...
  export type ConversationUpdateInput = {
    ...
    contextAccountIds?: ConversationUpdatecontextAccountIdsInput | string[]
    contextPropertyIds?: ConversationUpdatecontextPropertyIdsInput | string[]
  ...
  export type InsightCreateInput = {
    ...
    isRead?: boolean
    isDismissed?: boolean
    relatedTransactionIds?: InsightCreaterelatedTransactionIdsInput | string[]
    relatedConversationId?: string | null
    createdAt?: Date | string
  ...
  export type InsightUpdateInput = {
    ...
    relatedTransactionIds?: InsightUpdaterelatedTransactionIdsInput | string[]
    relatedConversationId?: NullableStringFieldUpdateOperationsInput | string | null
    createdAt?: DateTimeFieldUpdateOperationsInput | Date | string
  ...
  export type InsightCountOrderByAggregateInput = {
    ...
    isDismissed?: SortOrder
    relatedTransactionIds?: SortOrder
    relatedConversationId?: SortOrder
    createdAt?: SortOrder
    expiresAt?: SortOrder
  }
  ...
  export type AnalyticsCacheUserIdCacheKeyCompoundUniqueInput = {
    userId: string
    cacheKey: string
  }
  ...
  export type ConversationCreatecontextAccountIdsInput = {
    set: string[]
  }

  export type ConversationCreatecontextPropertyIdsInput = {
    set: string[]
  }
  ...
  export type ConversationUpdatecontextAccountIdsInput = {
    set?: string[]
    push?: string | string[]
  }

  export type ConversationUpdatecontextPropertyIdsInput = {
    set?: string[]
    push?: string | string[]
  }
  ...
  export type InsightCreaterelatedTransactionIdsInput = {
    set: string[]
  }
  ...
  export type InsightUpdaterelatedTransactionIdsInput = {
    set?: string[]
    push?: string | string[]
  }
